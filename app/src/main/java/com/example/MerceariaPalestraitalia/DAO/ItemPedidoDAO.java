...
public class ItemPedidoDAO {
    ...
    public boolean salvar(ItemPedido itemPedido){
        ...
        try {
             write.insert(DBHelper.TB_ITEM_PEDIDO, null,values);
        }catch (Exception e){
    ...
    public boolean atualizar(ItemPedido itemPedido){
        ...
        try {
            write.update(DBHelper.TB_ITEM_PEDIDO, values, where, args);
        }catch (Exception e){
    ...
    public boolean remover(ItemPedido itemPedido){
        ...
        try {
            write.delete(DBHelper.TB_ITEM_PEDIDO, where, args);
        }catch (Exception e){
    ...
    public Produto getProduto(int idProduto){
       ...
       String sql = " SELECT * FROM " + DBHelper.TB_ITEM + " WHERE id = " + idProduto + ";";
       Cursor cursor = read.rawQuery(sql, null);
        ...
        while (cursor.moveToNext()){
            ...
            produto.setUrlImagens(uploadList);
        }
        cursor.close();
        return produto;
    }
    ...
    public List<ItemPedido> getList(){
        ...
        String sql = "SELECT * FROM " + DBHelper.TB_ITEM_PEDIDO + ";";
        Cursor cursor = read.rawQuery(sql, null);
