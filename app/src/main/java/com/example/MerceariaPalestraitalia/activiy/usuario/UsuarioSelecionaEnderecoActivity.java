...
import com.example.MerceariaPalestraitalia.adapter.EnderecoSelecaoAdapter;
import com.example.MerceariaPalestraitalia.databinding.ActivityUsuarioSelecionaEnderecoBinding;
...
public class UsuarioSelecionaEnderecoActivity extends AppCompatActivity implements EnderecoSelecaoAdapter.OnClickListener {
    ...
    private void configClicks(){
        ...
        binding.btnCadastrarEndereco.setOnClickListener(view -> {
            resultLauncher.launch(new Intent(this, UsuariFormEnderecoActivity.class));
        });
    }
