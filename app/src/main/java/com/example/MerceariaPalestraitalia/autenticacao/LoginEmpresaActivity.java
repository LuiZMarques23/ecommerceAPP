...
import com.example.MerceariaPalestraitalia.databinding.ActivityLoginEmpresaBinding;
...
public class LoginEmpresaActivity extends AppCompatActivity {
    ...
    private ActivityLoginEmpresaBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLoginEmpresaBinding.inflate(getLayoutInflater());
