package com.example.MerceariaPalestraitalia.helper;
...
public class FirebaseHelper {
    ...
    public static String validaErro(String erro){
        String mensagem = "";
        ...
        } else if (erro.contains("The e-mail address is already in use by another account")) {
            mensagem = "Este e-mail já está em uso.";
        } else if (erro.contains("Password should be at least 6 characters")) {
            mensagem = "Insire uma senha mais forte.";
        }
        return mensagem;
    }
