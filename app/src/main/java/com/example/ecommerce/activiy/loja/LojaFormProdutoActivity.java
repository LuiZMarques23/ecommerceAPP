...
import com.example.ecommerce.adapter.CategoriaDialogAdapter;
import com.example.ecommerce.databinding.ActivityLojaFormProdutoBinding;
import com.example.ecommerce.databinding.BottomSheetProdutoBinding;
...
public class LojaFormProdutoActivity extends AppCompatActivity implements CategoriaDialogAdapter.onClick {
    ...
    private void configProduto(){
        ...
        Picasso.get().load(produto.getUrlImagens().get(0).getCaminhoImagem()).into(binding.imagemProduto0);
        Picasso.get().load(produto.getUrlImagens().get(1).getCaminhoImagem()).into(binding.imagemProduto1);
        Picasso.get().load(produto.getUrlImagens().get(2).getCaminhoImagem()).into(binding.imagemProduto2);
